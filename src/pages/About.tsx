...
const team: {
...
}[] = [
  {
    ...
    motto: "Leads with heart first, spreadsheets second.",
    bio: "Sets the vision for emotion-led travel at SurpreSaFeel and keeps the team aligned on why every itinerary should feel personal—not generic.",
  },
  {
  ...
  },
  {
    ...
    motto: "Clean books, calm ops.",
    bio: "Keeps invoices, reimbursements, and admin workflows tidy so planners and travelers never feel lost in paperwork.",
  },
  {
    ...
    bio: "Supports finance and admin alongside the team—numbers stay accurate and deadlines stay visible behind the scenes.",
  },
  {
    ...
    bio: "Builds day-by-day itineraries that match your pace and mood. Still sketches routes by hand when a trip needs extra soul.",
  },
  {
    ...
    bio: "First voice many travelers hear when they have questions. Turns worries into clear next steps so nobody feels stuck before departure.",
  },
  {
    name: "Sarah Faye S. Selmo",
    role: "Travel Planner",
    photo: null,
    motto: "Designs days around how you want to feel.",
    bio: "Turns emotional notes from the quiz into concrete stops, meals, and pacing—so the plan matches the person, not a template.",
  },
];
